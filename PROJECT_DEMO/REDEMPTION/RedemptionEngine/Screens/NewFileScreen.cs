...
namespace RedemptionEngine.Screens
{
    class NewFileScreen: GameScreen
    {
        ...
        public override void DrawPaused(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Select a File to Overwrite", new Vector2(40f, 40f), Color.Black * .5f);
        ...
        public override void DrawActive(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Select a File to Overwrite", new Vector2(40f, 40f), Color.Black * transitionTime);
        ...
        public override void DrawTransitionOn(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, "Select a File to Overwrite", new Vector2(40f * transitionTime, 40f), Color.Black * transitionTime);
