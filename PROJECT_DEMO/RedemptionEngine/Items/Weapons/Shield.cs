...
namespace RedemptionEngine.Items.Weapons
{
    public class Shield : Weapon
    {
            ...
            : base(content)
        {
            ...
            animations.Add("Inventory", new Animation(new Point(0, 0), new Point(15, 15), 1, 1000));
            animations.Add("Use", new Animation(new Point(15, 0), new Point(15, 15), 1, 1000));
            CurrentAnimationKey = "Inventory";
            texture = content.Load<Texture2D>("Items//Weapons//shield");

            AddModifier("Defense + 3", "Defense", 3, false);
        }
