...
{
    public class RainBow: Weapon
    {
        public RainBow(ContentManager content)
            : base(content)
        {
            POWER = 10;
            name = "Rain Bow";
            ...
            texture = content.Load<Texture2D>("Items//Weapons//rainBow");
            

            AddAnimation("Inventory",
                new Animation(new Point(0, 0), new Point(32, 32), 11, 200));
