...
{
    public class RaySword : Weapon
    {
        
        public RaySword(ContentManager content)
            : base(content)
        {
            POWER = 9;
            name = "Ray Sword";
            ...
            texture = content.Load<Texture2D>("Items//Weapons//Lightsaber");

            AddModifier("Strength + 10", "Strength", 10, false);
        }
